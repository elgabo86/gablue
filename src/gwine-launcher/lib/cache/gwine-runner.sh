...
################################################################################
# gwine-runner.sh - Téléchargement et installation de gwine
#
# Ce module gère le téléchargement, l'installation depuis le cache,
# et la mise à jour du runner gwine depuis GitHub.
# Le runner est installé dans ~/.local/share/gwine/runner
################################################################################
...
install_gwine_from_cache() {
    local WINE_INSTALL_DIR="$GWINE_DIR/runner"
